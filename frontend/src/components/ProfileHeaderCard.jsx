...
const ProfileHeaderCard = ({
  ...
  const problemsInPlaylists = playlists.reduce((acc, p) => acc + p.problems.length, 0);
            ...
            <div className="relative shrink-0">
              <div className="w-32 h-32 rounded-3xl bg-gradient-to-br from-blue-500/30 to-purple-500/30 backdrop-blur-sm p-1.5 shadow-2xl border border-white/10">
                {authUser?.image ? (
                  ...
                  <div className="w-full h-full rounded-2xl bg-gray-800/90 flex items-center justify-center">
            ...
            <div className="flex-1 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                ...
                <div className="flex items-center gap-2 bg-black/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/10">
                  ...
                  <span className="text-gray-200 capitalize">{authUser?.role}</span>
                </div>
                
                <div className="flex items-center gap-2 bg-black/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/10">
                  <Hash className="w-4 h-4 text-gray-400" />
                  <span className="text-gray-200">ID: {authUser?.id || "USER123"}</span>
                </div>
                
                <div className="flex items-center gap-2 bg-black/20 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/10">
                  <Calendar className="w-4 h-4 text-green-400" />
                  <span className="text-gray-200">Member since 2024</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <div className="bg-base-200 rounded-xl p-4 text-base-content shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-base-300/50">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold">{problemsInPlaylists}</span>
              </div>
            ...
            <div className="bg-base-200 rounded-xl p-4 text-base-content shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-base-300/50">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold">{totalCorrectSubmissions}</span>
              </div>
            ...
            <div className="bg-base-200 rounded-xl p-4 text-base-content shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-base-300/50">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold">{totalWrongSubmissions}</span>
              </div>
