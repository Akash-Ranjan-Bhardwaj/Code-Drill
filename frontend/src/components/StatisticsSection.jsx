...
// Mock axios instance for demo - replace with your actual axios instance
const axiosInstance = {
  get: async (url) => {
    // Mock API response
    ...
    return {
      data: {
        problems: [
          ...
          { difficulty: 'medium', tags: ['Graph', 'BFS'] },
          { difficulty: 'medium', tags: ['Dynamic Programming', 'String'] },
          { difficulty: 'hard', tags: ['Tree', 'Dynamic Programming'] },
          { difficulty: 'hard', tags: ['Graph', 'Backtracking'] },
          { difficulty: 'easy', tags: ['Math', 'Number Theory'] },
          { difficulty: 'easy', tags: ['String', 'Pattern Matching'] },
          { difficulty: 'medium', tags: ['Sorting', 'Divide and Conquer'] },
        ]
      }
    };
  }
    ...
    const fetchSolvedProblems = async () => {
      try {
        ...
        const difficultyCounts = problems.reduce(
          (acc, p) => {
            const level = p.difficulty?.toUpperCase() || 'UNKNOWN';
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <StatCard 
              ...
              value={Object.entries(stats.tags).sort(([,a], [,b]) => b - a)[0]?.[0] || 'N/A'}
              subtitle={`${Object.entries(stats.tags).sort(([,a], [,b]) => b - a)[0]?.[1] || 0} problems`}
              color="yellow"
            />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* Submission Stats - Vertical Bar Chart */}
            <div className="bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-700">
              <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
